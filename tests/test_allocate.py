...
class TestAllocateIP:
    ...
    def test_handler_returns_ip_on_success(self):
        with patch('handler.allocate_ip', return_value='10.10.10.55'):
    ...
    def test_handler_raises_on_ipam_failure(self):
        with patch('handler.allocate_ip', side_effect=ValueError("No free IPs")):
    ...
    def test_handler_uses_resource_name(self):
        with patch('handler.allocate_ip', return_value='10.10.10.60') as mock_alloc:
    ...
    def test_handler_handles_missing_resource_name(self):
        with patch('handler.allocate_ip', return_value='10.10.10.61'):
